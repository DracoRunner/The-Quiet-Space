        ...
        >
            ...
            >
                <div className="flex justify-between items-start mb-6">
                    <h3 id="bookingModalTitle" className="text-3xl font-bold text-[#B48B7F]">
                        {isSubmitted ? "Request Sent!" : "Book Your Session"}
                    </h3>
                    <button onClick={() => toggleModal(false)} className="text-[#2C3531] hover:text-red-500 transition" aria-label="Close modal">
                ...
                {isSubmitted ? (
                    <div className="text-center">
                        <p className="text-gray-700 text-lg">Thank you for reaching out! We will get back to you at <span className="font-semibold">{formData.email}</span> shortly to confirm your session.</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="when" className="block text-sm font-medium text-gray-700">When would you like to connect?</label>
                            <input
                                type="datetime-local"
                                name="when"
                                id="when"
                         ...
                         <div>
                            <label htmlFor="reason" className="block text-sm font-medium text-gray-700">What would you like to discuss?</label>
                            <textarea
                                name="reason"
                                id="reason"
                                rows={4}
                        ...
                        <p className="text-center text-xs text-gray-500 pt-2">This is a request, not a confirmation. We will email you to finalize the date and time.</p>
                    </form>
                )}
            </div>
        </div>
